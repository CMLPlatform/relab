...
def test_pluralization_handles_existing_backend_model_names() -> None:
...
def test_pluralization_handles_y_suffix_edge_cases() -> None:
...
def test_model_label_plural_uses_human_readable_plural() -> None:
