"""CRUD-operation tests for background data domain modules."""

from __future__ import annotations

from unittest.mock import AsyncMock, MagicMock, patch

from app.api.background_data.crud.categories import delete_category, update_category
...
from app.api.background_data.models import Material, ProductType, Taxonomy, TaxonomyDomain
