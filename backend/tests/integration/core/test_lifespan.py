...
class TestLifespan:
    ...
    async def test_startup_sets_redis_on_app_state(self) -> None:
        ...
        with (
            ...
            patch("app.core.lifecycle.init_cache"),
            patch("app.core.lifecycle.init_telemetry"),
            patch("app.core.lifecycle.close_cache"),
    ...
    async def test_shutdown_shuts_down_telemetry(self) -> None:
        ...
        with (
            ...
            patch("app.core.lifecycle.init_cache"),
            patch("app.core.lifecycle.init_telemetry"),
            patch("app.core.lifecycle.close_cache") as mock_close_cache,
            patch("app.core.lifecycle.close_redis"),
        ...
        mock_close_cache.assert_awaited_once()
