...
def load_sqlmodel_models() -> None:
    ...
    from app.api.data_collection import models as _data_collection_models  # noqa: F401, PLC0415
    ...
    from app.api.newsletter import models as _newsletter_models  # noqa: F401, PLC0415
    from app.api.plugins.rpi_cam import models as _rpi_cam_models  # noqa: F401, PLC0415
