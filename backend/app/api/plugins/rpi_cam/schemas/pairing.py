...
class PairingRegisterRequest(BaseModel):
    """RPi -> backend: register a pairing code and public device key."""
    ...
    public_key_jwk: RelayPublicKeyJWK = Field(description="Public P-256 JWK generated by the RPi.")
...
class PairingPollResponse(BaseModel):
    ...
    auth_scheme: Literal["device_assertion"] | None = None
