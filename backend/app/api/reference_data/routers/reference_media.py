...
from app.api.file_storage.crud.parent_media import list_parent_media
...
if TYPE_CHECKING:
    ...
    from app.api.file_storage.crud.parent_media import ParentMedia
...
async def list_reference_media_reads[StorageT: StorageModel, CreateT: StorageCreateSchema, ReadT: BaseModel](
    ...
    media: ParentMedia[StorageT, CreateT],
    parent_id: int,
