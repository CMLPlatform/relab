...
from app.api.auth.dependencies import CurrentActiveVerifiedUserDep, OrgAsOwner, current_active_verified_user
...
router = APIRouter(prefix="/users", tags=["users"], dependencies=[Security(current_active_verified_user)])
