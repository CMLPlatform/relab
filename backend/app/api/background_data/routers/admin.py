"""Admin background-data router composition."""
...
from app.api.background_data.routers.admin_categories import router as category_router
from app.api.background_data.routers.admin_materials import router as material_router
from app.api.background_data.routers.admin_product_types import router as product_type_router
from app.api.background_data.routers.admin_taxonomies import router as taxonomy_router
