...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("source", sqlmodel.AutoString(length=50), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=True),
        sa.Column("name", sqlmodel.AutoString(length=50), nullable=False),
        sa.Column("location", sqlmodel.AutoString(length=50), nullable=True),
        sa.Column("description", sqlmodel.AutoString(length=500), nullable=True),
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("encrypted_api_key", sqlmodel.AutoString(), nullable=False),
        sa.Column("encrypted_auth_headers", sqlmodel.AutoString(), nullable=True),
        sa.Column("owner_id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=True),
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=True),
        sa.Column("name", sqlmodel.AutoString(length=250), nullable=False),
        sa.Column("description", sqlmodel.AutoString(length=500), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("name", sqlmodel.AutoString(length=50), nullable=False),
        sa.Column("description", sqlmodel.AutoString(length=500), nullable=True),
        sa.Column("brand", sqlmodel.AutoString(length=100), nullable=True),
        sa.Column("model", sqlmodel.AutoString(length=100), nullable=True),
        sa.Column("dismantling_notes", sqlmodel.AutoString(length=500), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("file", file_storage_custom_types.FileType(), nullable=False),
        sa.Column(
            "parent_type",
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("filename", sqlmodel.AutoString(), nullable=False),
        sa.Column("file", file_storage_custom_types.ImageType(), nullable=False),
        sa.Column(
            "parent_type",
