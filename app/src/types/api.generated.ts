...
export interface paths {
  ...
  '/v1/admin/users/{user_id}': {
    ...
    /**
     * Update a user by ID
     * @description Update a user by ID without requiring the target account's password.
     *
  ...
  '/v1/plugins/rpi-cam/cameras/{camera_id}/preview-thumbnail': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    /**
     * Get a camera's cached preview thumbnail
     * @description Serve the owner's cached preview thumbnail.
     *
  ...
  '/v1/plugins/rpi-cam/pairing/poll': {
     ...
     */
    post: operations['poll_pairing_status_v1_plugins_rpi_cam_pairing_poll_post'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    /**
     * PairingPollRequest
     * @description Pi -> backend: poll pairing status.
     *
    ...
    PairingPollRequest: {
      /**
       * Code
       * @description Pairing code generated by the Pi.
       */
      code: string;
      /**
       * Fingerprint
...
export interface operations {
  ...
  get_camera_preview_thumbnail_v1_plugins_rpi_cam_cameras__camera_id__preview_thumbnail_get: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    responses: {
      ...
      /** @description No cached preview thumbnail available for this camera. */
      404: {
        headers: {
          [name: string]: unknown;
        };
  ...
  poll_pairing_status_v1_plugins_rpi_cam_pairing_poll_post: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['PairingPollRequest'];
      };
    };
    responses: {
      /** @description Successful Response */
