...
const mockedLaunchImageLibraryAsync = jest.mocked(launchImageLibraryAsync);
const mockedLaunchCameraAsync = jest.mocked(launchCameraAsync);
const mockedRequestCameraPermissionsAsync = jest.mocked(requestCameraPermissionsAsync);
const mockedProcessImage = jest.mocked(processImage);
