  ...
  return (
    <>
      ...
      <RegenerateCodesDialog
        ...
        submitRegenerate={submitRegenerate}
        triggerRef={regenerateTriggerRef}
      />

      <RecoveryCodesDialog
        visible={mfa.mode === 'codes'}
        cancel={cancel}
...
type DisableMfaDialogProps = {
  mfa: MfaSetupController;
  cancel: () => void;
  disable: () => void;
  submitDisable: () => void;
  triggerRef?: RefObject<View | null>;
  local: ReturnType<typeof createMfaDialogStyles>;
  theme: AppTheme;
};
...
function DisableMfaDialog({
  ...
  return (
    <AppDialog
      visible={mfa.mode === 'disable'}
      onDismiss={cancel}
      triggerRef={triggerRef}
      accessibilityLabel="Enter a current code"
    >
      <AppText variant="title" {...heading(2)} style={dialogTitleStyle}>
...
type RegenerateCodesDialogProps = {
  mfa: MfaSetupController;
  cancel: () => void;
  regenerate: () => void;
...
function RegenerateCodesDialog({
  ...
  return (
    <AppDialog
      ...
      onDismiss={cancel}
      triggerRef={triggerRef}
      accessibilityLabel="Regenerate recovery codes"
    >
      <AppText variant="title" {...heading(2)} style={dialogTitleStyle}>
...
type RecoveryCodesDialogProps = {
  visible: boolean;
  cancel: () => void;
  recoveryCodes: string[] | null | undefined;
...
function RecoveryCodesDialog({
  ...
  return (
    <AppDialog
      ...
      onDismiss={cancel}
      dismissable={false}
      accessibilityLabel="Save your recovery codes"
    >
      <AppText variant="title" {...heading(2)} style={dialogTitleStyle}>
