...
Good product data is hard to get: what something is made of, and what evidence supports the claim.
Relab works with the people who already open products, so routine repair and dismantling work
leaves structured records anyone can reuse. [Project context](project/) sets out the argument.
