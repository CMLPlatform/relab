...
C4Component
    ...
    Container_Boundary(backend, "FastAPI Backend") {
        ...
        Component(referencedata, "Reference Data", "SQLAlchemy / FastAPI", "Taxonomies, categories, materials, product types — cached reference data")
        Component(filestorage, "File Storage", "FastAPI", "File and image upload, generated media URLs, WebP conversion, periodic orphan cleanup")
    ...
    Rel(datacollection, referencedata, "References categories, materials, types")
