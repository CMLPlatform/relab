...
<details>
<summary>Styled architecture overview (ELK layout)</summary>
...
For formal C4 architecture views (Context, Container, Component), see [C4 Architecture Diagrams](../c4-diagrams/).
