...
For the live schema and request models, use the [interactive API documentation](/api/public/). For practical usage guidance, see the [API interaction guide](../../user-guides/api/).
