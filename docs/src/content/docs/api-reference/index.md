...
For practical scripting guidance, start with the [API interaction guide](../user-guides/api/). For implementation architecture, see [API structure](../architecture/api/).
