...
- :material-database:{ .lg .middle } __Data Collection__

  Structured logging of product disassembly, components, and materials.

- :material-camera:{ .lg .middle } __RPI Camera Integration__

  Seamless integration with Raspberry Pi cameras for high-quality image capture.

- :material-api:{ .lg .middle } __Powerful API__

  Extensible FastAPI backend with automated documentation and client support.

- :material-chart-bubble:{ .lg .middle } __Circular Economy__

  Insights into product design and material recovery to support sustainability research.
